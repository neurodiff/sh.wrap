...
export SCRIPT="./_actions/src/docsy-site.sh"
...
export DOCS_DIR="./test/docsy-site/site/content"
export SITE_DIR="./test/docsy-site/site"
export PUBLIC_DIR="./_actions/public"
export PUBLIC_CACHE="hugo-site-01-02"
